...
namespace Microsoft.EntityFrameworkCore.Modeling
{
	...
	/// </summary>
	internal partial class EntityFrameworkCoreDocData : EntityFrameworkCoreDocDataBase
	{
		/// <summary>
		/// Constructs a new EntityFrameworkCoreDocData.
		/// </summary>
		public EntityFrameworkCoreDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a EntityFrameworkCore document in memory.
	/// </summary>
	internal abstract partial class EntityFrameworkCoreDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new EntityFrameworkCoreDocDataBase.
		/// </summary>
		protected EntityFrameworkCoreDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Microsoft.EntityFrameworkCore.Modeling.Model modelRoot = null;
			...
			global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::Microsoft.EntityFrameworkCore.Modeling.Model modelRoot = this.RootElement as global::Microsoft.EntityFrameworkCore.Modeling.Model;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::Microsoft.EntityFrameworkCore.Modeling.Diagram diagram = diagrams[0] as global::Microsoft.EntityFrameworkCore.Modeling.Diagram;
					if (diagram != null)
					{
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Microsoft.EntityFrameworkCore.Modeling.Model modelRoot = (global::Microsoft.EntityFrameworkCore.Modeling.Model)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
