...
namespace Microsoft.EntityFrameworkCore.Modeling
{
	...
	/// </summary>
	internal partial class EntityFrameworkCoreExplorer : EntityFrameworkCoreExplorerBase
	{
		/// <summary>
		/// Constructs a new EntityFrameworkCoreExplorer.
		/// </summary>
		public EntityFrameworkCoreExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the EntityFrameworkCoreExplorerToolWindow.
	/// </summary>
	internal abstract class EntityFrameworkCoreExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new EntityFrameworkCoreExplorerBase.
		/// </summary>
		protected EntityFrameworkCoreExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.EntityFrameworkCoreExplorerMenu;
			}
		}
		...
		{
			get { return global::Microsoft.EntityFrameworkCore.Modeling.Model.DomainClassId; }
		}
