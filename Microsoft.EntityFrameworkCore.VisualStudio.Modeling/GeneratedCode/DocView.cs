...
namespace Microsoft.EntityFrameworkCore.Modeling
{
	...
	/// </summary>
	internal partial class EntityFrameworkCoreDocView : EntityFrameworkCoreDocViewBase
	{
		/// <summary>
		/// Constructs a new EntityFrameworkCoreDocView.
		/// </summary>
		public EntityFrameworkCoreDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class EntityFrameworkCoreDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new EntityFrameworkCoreDocView.
		/// </summary>
		protected EntityFrameworkCoreDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			EntityFrameworkCoreDocDataBase docData = this.DocData as EntityFrameworkCoreDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for EntityFrameworkCoreDocViewBase should be an EntityFrameworkCoreDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Microsoft.EntityFrameworkCore.Modeling.Diagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Microsoft.EntityFrameworkCore.Modeling.Diagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.EntityFrameworkCoreDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Microsoft.EntityFrameworkCore.Modeling.EntityFrameworkCoreHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
