...
namespace Microsoft.EntityFrameworkCore.Modeling
{
	...
	/// </remarks>
	public partial class EntityFrameworkCoreHelpKeywordHelper : EntityFrameworkCoreHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new EntityFrameworkCoreHelpKeywordHelper.
		/// </summary>
		protected EntityFrameworkCoreHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the EntityFrameworkCoreHelpKeywordHelper.
		/// </summary>
		public static EntityFrameworkCoreHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class EntityFrameworkCoreHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new EntityFrameworkCoreHelpKeywordHelperBase.
		/// </summary>
		protected EntityFrameworkCoreHelpKeywordHelperBase()
			: base() { }
