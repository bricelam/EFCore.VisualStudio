...
namespace Microsoft.EFDesigner
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.EFDesignerEditorFactoryId)]
	internal partial class EFDesignerEditorFactory : EFDesignerEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new EFDesignerEditorFactory.
		/// </summary>
		public EFDesignerEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class EFDesignerEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected EFDesignerEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new EFDesignerDocData(this.ServiceProvider, typeof(EFDesignerEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new EFDesignerDocView(docData, this.ServiceProvider);
		}
	}
}
