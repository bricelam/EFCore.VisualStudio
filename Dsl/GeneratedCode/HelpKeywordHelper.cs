...
namespace Microsoft.EFDesigner
{
	...
	/// </remarks>
	public partial class EFDesignerHelpKeywordHelper : EFDesignerHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new EFDesignerHelpKeywordHelper.
		/// </summary>
		protected EFDesignerHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the EFDesignerHelpKeywordHelper.
		/// </summary>
		public static EFDesignerHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class EFDesignerHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new EFDesignerHelpKeywordHelperBase.
		/// </summary>
		protected EFDesignerHelpKeywordHelperBase()
			: base() { }
