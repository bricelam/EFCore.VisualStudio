...
namespace Microsoft.EFDesigner
{
	...
	/// </remarks>
	public partial class EFDesignerToolboxHelper : EFDesignerToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new EFDesignerToolboxHelper.
		/// </summary>
		public EFDesignerToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class EFDesignerToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify EFDesigner toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "EFDesigner.1.0";
		...
		/// <summary>
		/// Constructs a new EFDesignerToolboxHelperBase.
		/// </summary>
		protected EFDesignerToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Microsoft.EFDesigner.EFDesignerDomainModel.SingletonResourceManager.GetString("EFDesignerToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Microsoft.EFDesigner.EFDesignerDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Microsoft.EFDesigner.EntityTypeToolboxItem":
					// Add EntityType shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Microsoft.EFDesigner.EntityTypeToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Microsoft.EFDesigner.EFDesignerToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("EFDesignerToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"EntityTypeF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("EntityTypeToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Microsoft.EFDesigner.EntityType.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Microsoft.EFDesigner.PropertyToolboxItem":
					// Add Property shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Microsoft.EFDesigner.PropertyToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Microsoft.EFDesigner.EFDesignerToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("EFDesignerToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"PropertyF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("PropertyToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Microsoft.EFDesigner.Property.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Microsoft.EFDesigner.EFDesignerDomainModel));
